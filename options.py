...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--resize_size', type=int, default=448, help='resized image size for training')
    self.parser.add_argument('--crop_size', type=int, default=448, help='cropped image size for training')
    ...
    self.parser.add_argument('--display_freq', type=int, default=20, help='freq (iteration) of display')
    ...
    self.parser.add_argument('--n_ep', type=int, default=400, help='number of epochs') # 400 * d_iter
    ...
    self.parser.add_argument('--lambda_rec', type=float, default=10) # lambda 1,2
    self.parser.add_argument('--lambda_cls', type=float, default=1.0) # lambda 5
    self.parser.add_argument('--lambda_cls_G', type=float, default=5.0)
    self.parser.add_argument('--lambda_cl_attr', type=float, default=0) #lambda 6
    self.parser.add_argument('--lambda_cl_cont', type=float, default=0) #lambda 7
